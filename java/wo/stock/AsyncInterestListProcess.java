...
public class AsyncInterestListProcess extends AsyncTask<Void, Void, StockVO> {
    private String code;
    public AsyncInterestListProcess(String code) {
        this.code = code;
    }
    ...
    protected StockVO doInBackground(Void... voids) {
        ...
        String name = stockElements01.get(1).text().split(" ")[1]; // 스페이스 기준으로 인덱스 1로 하기.
